...
web build:
 - http://mootools.net/core/c9413582f8acbc327a0cc7065612ca7b

packager build:
 - packager build Core/Element.Dimensions Core/Request Core/DOMReady
...
},getLeft:function(){return this.getPosition().x;}});Object.extend({subset:function(c,f){var e={};for(var d=0,a=f.length;d<a;d++){var b=f[d];e[b]=c[b];
...
}});return c.join("&");}});(function(){var a=this.Class=new Type("Class",function(h){if(instanceOf(h,Function)){h={initialize:h};}var g=function(){e(this);
